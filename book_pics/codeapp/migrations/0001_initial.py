# Generated by Django 5.1.7 on 2025-04-24 06:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_objects', models.ManyToManyField(to='codeapp.tag')),
            ],
        ),
        migrations.CreateModel(
            name='OrderSummary',
            fields=[
                ...
                ('project_objects', models.ManyToManyField(to='codeapp.project')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('project_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codeapp.project')),
                ('wishlist_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='basket_items', to='codeapp.wishlist')),
            ],
        ),
    ]
